 ...
 */
public final class ProcessTerminalSession extends TerminalOutput implements TerminalSession {
    ...
    public ProcessTerminalSession(String shellPath, String cwd, String[] args, String[] env, Integer transcriptRows, TerminalSessionClient client) {
     ...
     *               for communication between {@link ProcessTerminalSession} and its client.
     */
    @Override
    ...
    class MainThreadHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MSG_PROCESS_EXITED) {
                ...
                mClient.onSessionFinished(ProcessTerminalSession.this);
            }
        }
